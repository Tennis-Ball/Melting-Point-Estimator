...
bert_model_name = 'small_bert/bert_en_uncased_L-4_H-512_A-8'  # identify bert model
...
# train model
history = model.fit(x=trainX, y=trainY, epochs=epochs, validation_data=(valX, valY))
# evaluate model
